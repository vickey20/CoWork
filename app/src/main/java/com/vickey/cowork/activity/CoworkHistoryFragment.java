...
public class CoworkHistoryFragment extends Fragment implements CardViewAdapter.CardViewAdapterListener {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        Log.d(TAG, "cowork size: " + mCoWorks.size());
        ...
        mAdapter = new CardViewAdapter(getActivity(), CoworkHistoryFragment.this, mCoWorks, CardViewAdapter.DISPLAY_TYPE_CHOOSE_FROM_HISTORY);
        mRecyclerView.setAdapter(mAdapter);
        mRecyclerView.setVisibility(RecyclerView.VISIBLE);
    }
